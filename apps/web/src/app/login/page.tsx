        ...
        <div className='min-h-screen flex items-center justify-center bg-muted/40 px-4 py-12'>
            <Card className="w-full max-w-md shadow-sm">
                <CardHeader>
                    ...
                    <CardDescription>Sign in to your SuperVolt account</CardDescription>
                </CardHeader>
                <CardContent>
                    {state.error && (
                    ...
                    >
                        ...
                        <Button type="submit" name="intent" value={AUTH_INTENT.LOGIN} disabled={isPending} size="lg" className="w-full">
